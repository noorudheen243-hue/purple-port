@echo off
echo ========================================================
echo   QIX ADS DEPLOYMENT V6 (AUTO-MAGIC)
echo ========================================================
echo.
...
ssh root@72.61.246.22 "cd /var/www/purple-port && unzip -o deploy_fix_v6.zip && cp -r client_dist/* server/public/ && pm2 restart qix-api"
