...
const routes_17 = __importDefault(require("./modules/marketing-tasks/routes"));
const routes_18 = __importDefault(require("./modules/settings/routes"));
const path_1 = __importDefault(require("path"));
// Serve Uploads
app.use('/api/uploads', express_1.default.static(path_1.default.join(process.cwd(), 'uploads')));
const routes_19 = __importDefault(require("./modules/system/routes")); // Legacy System Routes
const routes_20 = __importDefault(require("./modules/deployment/routes")); // New Auto-Update Routes
...
app.use('/api/system', routes_19.default);
app.use('/api/deployment', routes_20.default); // Registered here
app.use('/api/client-portal', routes_16.default);
app.use('/api/marketing', routes_17.default);
app.use('/api/payroll', routes_14.default);
app.use('/api/backup', routes_15.default);
const routes_21 = __importDefault(require("./modules/sticky_notes/routes"));
const routes_22 = __importDefault(require("./modules/team/resignation/routes"));
const routes_23 = __importDefault(require("./modules/attendance/routes"));
const biometric_control_routes_1 = __importDefault(require("./modules/attendance/biometric_control.routes"));
const routes_24 = __importDefault(require("./modules/billing/routes"));
const routes_25 = __importDefault(require("./modules/leave/routes"));
app.use('/api/billing', routes_24.default);
app.use('/api/sticky-notes', routes_21.default);
app.use('/api/team/resignation', routes_22.default); // New Module
app.use('/api/attendance/biometric', biometric_control_routes_1.default); // Specific route first
app.use('/api/attendance', routes_23.default); // Generic route second
app.use('/api/leave', routes_25.default);
app.use('/api/settings', routes_18.default);
const routes_26 = __importDefault(require("./modules/chat/routes"));
const routes_27 = __importDefault(require("./modules/launcher/routes"));
const routes_28 = __importDefault(require("./modules/admin/routes"));
const routes_29 = __importDefault(require("./modules/meetings/routes"));
app.use('/api/chat', routes_26.default);
app.use('/api/launcher', routes_27.default);
app.use('/api/admin', routes_28.default);
app.use('/api/meetings', routes_29.default);
