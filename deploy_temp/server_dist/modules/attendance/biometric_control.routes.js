...
router.get('/users/unlinked', middleware_1.protect, (0, middleware_1.authorize)('ADMIN', 'MANAGER', 'DEVELOPER_ADMIN'), biometric_controller_1.BiometricController.getUnlinkedDeviceUsers);
router.post('/users/link', middleware_1.protect, (0, middleware_1.authorize)('ADMIN', 'MANAGER', 'DEVELOPER_ADMIN'), biometric_controller_1.BiometricController.linkDeviceUser);
...
router.post('/bridge/upload-users', requireApiKey, biometric_controller_1.BiometricController.uploadUsersFromBridge);
