...
router.delete('/delete/:filename', middleware_1.protect, (0, middleware_1.authorize)('DEVELOPER_ADMIN'), controller_1.deleteBackup);
router.post('/delete-multiple', middleware_1.protect, (0, middleware_1.authorize)('DEVELOPER_ADMIN'), controller_1.deleteMultipleBackups);
