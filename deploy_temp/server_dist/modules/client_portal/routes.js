...
router.delete('/activity-logs/all', (0, middleware_1.authorize)('ADMIN', 'DEVELOPER_ADMIN'), activityController.deleteAllActivityLogs);
router.delete('/activity-logs/selected', (0, middleware_1.authorize)('ADMIN', 'DEVELOPER_ADMIN'), activityController.deleteSelectedActivityLogs);
...
router.delete('/tracking/web-dev/:id', (0, middleware_1.authorize)('ADMIN', 'MANAGER', 'DM_EXECUTIVE', 'WEB_SEO_EXECUTIVE', 'MARKETING_EXEC', 'CREATIVE_DESIGNER', 'OPERATIONS_EXECUTIVE'), trackingController.deleteWebProject);
