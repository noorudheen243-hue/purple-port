    ...
    static applyLeave(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const { type, start_date, end_date, reason, is_half_day } = req.body;
                const leave = yield service_1.LeaveService.applyLeave(userId, type, new Date(start_date), new Date(end_date), reason, is_half_day);
