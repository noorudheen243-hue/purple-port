...
const onboardSchema = zod_1.z.object({
    ...
    status: zod_1.z.enum(['ACTIVE', 'RELIEVED']).optional(),
...
const listStaff = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b;
    try {
        const includeHidden = ((_a = req.user) === null || _a === void 0 ? void 0 : _a.role) === 'ADMIN' || ((_b = req.user) === null || _b === void 0 ? void 0 : _b.role) === 'DEVELOPER_ADMIN';
        const includeRelieved = req.query.include_relieved === 'true';
        const staff = yield teamService.listStaff(includeHidden, includeRelieved);
        res.json(staff);
    }
    catch (error) {
        res.status(500).json({ message: error.message });
