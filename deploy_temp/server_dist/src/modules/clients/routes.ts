...
router.post('/credentials/generate', authorize('ADMIN', 'MANAGER'), generateCredentials);
router.get('/credentials', authorize('ADMIN', 'MANAGER'), listCredentials);
router.put('/credentials/:id', authorize('ADMIN', 'MANAGER'), updateCredentials);
