...
class BiometricControlService {
                ...
                try {
                    ...
                    if (isReachable) {
                        try {
                            if (yield this.connect()) {
                                const deviceUsersResp = yield this.zk.getUsers();
                                deviceUsers = (deviceUsersResp === null || deviceUsersResp === void 0 ? void 0 : deviceUsersResp.data) || [];
                                yield this.disconnect();
                            }
                        }
                        catch (e) {
                    ...
                    const existingCredentials = yield prisma_1.default.biometricCredential.findMany({ select: { staff_number: true } });
                    const linkedUserIds = new Set(existingCredentials.map(c => c.staff_number));
                    // Get all mapped devices from DB (New Method)
                    const linkedStaffProfiles = yield prisma_1.default.staffProfile.findMany({
                    ...
                    const unlinkedUsers = deviceUsers.filter((u) => {
    ...
    linkDeviceUser(deviceUserId, staffProfileId) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.mutex.run(() => __awaiter(this, void 0, void 0, function* () {
                var _a;
                try {
                    ...
                    yield prisma_1.default.staffProfile.update({
                        where: { id: staffProfileId },
                        data: { biometric_device_id: String(deviceUserId) }
                    });
                    return { message: `Device User ${deviceUserId} successfully linked to ${(_a = staff.user) === null || _a === void 0 ? void 0 : _a.full_name} (${staff.staff_number}).` };
                }
                catch (error) {
