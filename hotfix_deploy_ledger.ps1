...
try {
    ...
    Write-Host "Uploading updated LedgerFullView.tsx..."
    Set-SFTPItem -SessionId $sftpId -Path "f:\Antigravity\client\src\pages\accounts\LedgerFullView.tsx" -Destination "/var/www/purple-port/client/src/pages/accounts" -Force
