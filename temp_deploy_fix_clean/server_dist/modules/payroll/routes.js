...
router.get('/run', middleware_1.protect, (0, middleware_1.authorize)('ADMIN'), payrollController.getPayrollRun);
router.get('/history', middleware_1.protect, payrollController.getPayrollHistory);
router.post('/slip/:id/process', middleware_1.protect, (0, middleware_1.authorize)('ADMIN'), payrollController.processSlip);
router.delete('/slip/:id', middleware_1.protect, (0, middleware_1.authorize)('ADMIN'), payrollController.rejectSlip);
