...
class BiometricController {
    ...
    // Get Unlinked Users
    static getUnlinkedDeviceUsers(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const result = yield biometric_service_1.biometricControl.getUnlinkedDeviceUsers();
                res.json(result);
            }
            catch (error) {
                res.status(500).json({ error: error.message });
    ...
    static linkDeviceUser(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const result = yield biometric_service_1.biometricControl.linkDeviceUser(String(deviceUserId), String(staffProfileId));
                res.json(result);
            }
            catch (error) {
                res.status(500).json({ error: error.message });
    ...
    static uploadUsersFromBridge(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { users } = req.body;
                if (!Array.isArray(users))
                    throw new Error('Invalid users format. Expected array.');
                const result = yield biometric_service_1.biometricControl.cacheDeviceUsers(users);
                res.json(result);
            }
            catch (error) {
                res.status(500).json({ error: error.message });
