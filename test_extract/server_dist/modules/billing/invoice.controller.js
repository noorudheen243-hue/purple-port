...
exports.deleteInvoice = exports.updateInvoiceStatus = exports.getInvoiceById = exports.getInvoices = exports.createInvoice = void 0;
...
const deleteInvoice = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const isClientError = ((_a = error === null || error === void 0 ? void 0 : error.message) === null || _a === void 0 ? void 0 : _a.includes('DRAFT')) || ((_b = error === null || error === void 0 ? void 0 : error.message) === null || _b === void 0 ? void 0 : _b.includes('not found'));
        console.error("Delete Invoice Error:", error);
        res.status(isClientError ? 400 : 500).json({ error: (error === null || error === void 0 ? void 0 : error.message) || 'Failed to delete invoice.' });
    }
});
