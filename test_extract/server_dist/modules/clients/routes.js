...
router.post('/credentials/generate', (0, middleware_1.authorize)('ADMIN', 'MANAGER'), controller_1.generateCredentials);
router.get('/credentials', (0, middleware_1.authorize)('ADMIN', 'MANAGER'), controller_1.listCredentials);
router.put('/credentials/:id', (0, middleware_1.authorize)('ADMIN', 'MANAGER'), controller_1.updateCredentials);
