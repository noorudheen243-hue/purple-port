...
const getCreativeDashboardStats = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const tasksMonth = yield prisma_1.default.task.findMany({
        where: {
    ...
    const tableTasks = tasksMonth.filter(t => t.createdAt >= today || !['COMPLETED', 'CANCELLED'].includes(t.status));
    const formatTasksResponse = tableTasks.map((t, index) => {
        var _a, _b, _c;
        return ({
            s_no: index + 1,
            id: t.id,
            staff_name: ((_a = creatives.find(c => c.id === t.assignee_id)) === null || _a === void 0 ? void 0 : _a.full_name) || 'Unknown',
            client_name: ((_b = t.client) === null || _b === void 0 ? void 0 : _b.name) || 'Internal',
            task_type: t.type || 'Generic',
            assigned_by: ((_c = t.assigned_by) === null || _c === void 0 ? void 0 : _c.full_name) || 'System',
            status: t.status
        });
    });
    // 4. Helper to calculate efficiency from the CACHED task list
    const calculateEfficiencyFromList = (tasksList, sortKey = 'efficiency') => {
