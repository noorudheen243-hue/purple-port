...
exports.deleteInvoice = exports.updateInvoiceStatus = exports.getInvoiceById = exports.getInvoices = exports.createInvoice = exports.generateInvoiceNumber = void 0;
...
const deleteInvoice = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const invoice = yield prisma_1.default.clientInvoice.findUnique({ where: { id } });
    if (!invoice)
        throw new Error('Invoice not found');
    if (invoice.status !== 'DRAFT')
        throw new Error('Only DRAFT invoices can be deleted.');
    // Delete items first (in case no cascade configured), then invoice
    yield prisma_1.default.clientInvoiceItem.deleteMany({ where: { invoice_id: id } });
    return yield prisma_1.default.clientInvoice.delete({ where: { id } });
});
