...
const getTaskStats = (filters) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    tasks.forEach(task => {
        ...
        if (filters.groupBy === 'staff') {
            ...
            const staffName = ((_d = task.assignee) === null || _d === void 0 ? void 0 : _d.full_name) || 'Unassigned';
...
const getDigitalMarketingDashboardStats = (month, year) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const staffTasksRaw = yield prisma_1.default.task.groupBy({
        by: ['assignee_id'],
        where: Object.assign({ department: 'DIGITAL_MARKETING', assignee_id: { not: null } }, periodFilter),
        _count: { id: true }
    });
    ...
    const staffStats = staffTasksRaw.map(s => {
        var _a;
        return ({
            name: ((_a = staffMembers.find(m => m.id === s.assignee_id)) === null || _a === void 0 ? void 0 : _a.full_name) || 'Unknown',
            value: s._count.id
        });
    });
